    ...
    <div className="min-h-screen bg-[#050810] py-24 px-6 md:px-12 text-white">
      ...
      >
        ...
        <div className="space-y-8 text-gray-300 font-medium leading-relaxed font-sans">
          <p>
            Orders cannot be cancelled once submitted as processing begins immediately for instant delivery.
          </p>
          ...
          <div className="space-y-4">
            ...
            <p>
              If payment was deducted but the order was not processed or you encountered an error, please contact support within 1 hour for a possible manual cancellation and refund.
            </p>
          </div>
